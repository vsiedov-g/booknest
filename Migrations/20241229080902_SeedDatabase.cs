...
namespace booknest.Migrations
{
    ...
    public partial class SeedDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "AuthorId", "Description", "FilePath", "OrderId", "Price", "PublisherId", "Title" },
                values: new object[,]
                {
                    { 1, 1, "lie", null, null, 15.0, 1, "Lie" },
                    { 2, 2, "cold", null, null, 16.0, 2, "Cold" },
                    { 3, 3, "hot", null, null, 17.0, 3, "Hot" }
                });
            ...
            migrationBuilder.InsertData(
                table: "ProductUser",
                columns: new[] { "ProductsId", "UsersId" },
                values: new object[,]
                {
                    { 1, 1 },
                    { 2, 1 },
